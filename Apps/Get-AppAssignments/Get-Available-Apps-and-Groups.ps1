...
$Apps = (Invoke-MgGraphRequest -Method GET -Uri $uri).Value | Where-Object {$_.assignments.intent -like "available"}
...
# Export to CSV
$ExportPath = "$env:USERPROFILE\Downloads\IntuneAvailableApps.csv"
